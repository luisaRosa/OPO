<%@page import="br.ufac.bsi.ihm.controleDeDoacoes.Exception.FieldBlankException"%>
	...
	<div class="wrapper">
		...
		<div id="welcome" class="container">
			...
			<%if (request.getParameter("confirmar") != null) {
					...
					if((request.getParameter("nome") == null) && (request.getParameter("idade").equalsIgnoreCase("")) && 
							(request.getParameter("pupilas").equalsIgnoreCase("")) &&(request.getParameter("sedado")==null)
							&& (request.getParameter("informacoesAdd").equalsIgnoreCase(""))){%>
					
						<script type="text/javascript">
							
							alert(" Os campos Nome, Idade, Pupilas, Sedado e Informações Adicionais são obrigatórios!")
							
						</script>
			
					
				<%} else if((request.getParameter("nome") == null) || (request.getParameter("idade").equalsIgnoreCase(""))||
						(request.getParameter("pupilas").equalsIgnoreCase(""))||(request.getParameter("sedado")==null) ||
						(request.getParameter("informacoesAdd").equalsIgnoreCase(""))){%>
			...
			<div align="center"><div align="center"><label for="cararq" >Carregue o formulário usando um arquivo:
				...
				<fieldset>
					...
					<table cellspacing="10">
						...
						<tr>
							...
							<td align="left"><input id="nome" type="text" name="nome"  size="63"<%if (a != null){ %> value="<%= dado[0] %>"<%} %> ></p></label>
							</td>
							<td><label for="idade">Idade:* </label></td>
							<td align="left"><input type="number" name="idade" size="20"<%if (a != null){ %> value="<%= dado[1] %>"<%} %>>
							</td>
						</tr>
						<tr>
					...
					<table cellpadding="10" cellspacing="10">
						<tr>
							...
							<td align="right" width="20"><input type="text"
								name="pupilas" size="20" <%if (a != null){ %> value="<%= dado[3] %>"<%} %>/></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td><label>
						...
						<tr>
							...
							<td align="center" width="50"><input type="radio"
								name="sedado" value="sim" align="left" <% if(a != null && dado[9].equalsIgnoreCase("sim")){ %> checked="checked" <%} %>/> Sim <input
				...
				<fieldset>
					...
					<table>
						<tr>
							<textarea  name="informacoesAdd" ><%if (a != null){%><%=dado[10]%><%} %></textarea>
