	  ...
	  <h3>Excluir Usuário</h3>
		...
		<% usuarioLogic.setConexao(conexao);
			...
			if (request.getParameter("confirmar")!= null){%>	
				...
				<% int  num = usuarioLogic.addUsuario(usuario1);
		...
		<fieldset>
		 ...
		 <table cellspacing="10">
		  <tr>
		   ...
		   <td align="left">
		    <input type="text" name="nome" size="63" value="Luisa Rosa">
		   </td>
		   </tr>
		   <tr>
		   <td>
		   ...
		   <td align="left">
		    <input type="text" name="cpf" value="15691729780">
		   </td>
		  </tr>
		 </table>
		</fieldset>
		...
		<fieldset>
		 ...
		 <table cellspacing="10">
		  ...
		  <tr>
		   ...
		   <td align="left">
		    <input type="text" name="localTrabalho" size="60" value="OPO">
		   </td>
		   </tr>
		   <tr>
		   <td>
		   ...
		   <td align="left">
		    <input type="text" name="funcao" size="60" value="Enfermeira">
		   </td>
		  </tr>
