	...
	<div class="wrapper">
		<div id="welcome" class="container">
			...
			<br>
				...
				if(request.getParameter("confirmar")!=null){
		     	...
		     	<%} 	
					...
					resposta = evolucaoLogic.addEvolucaoPaciente(evolucaopaciente);
					
					if(resposta == 1){
						request.setAttribute("message", "Evolução efetuada com sucesso!");
			...
			<div class ="alert alert-danger">
	         ...
	         <p> Erro ao cadastrar evolução, por favor tente novamente!</p>
			</div>
			<%} %>
			
			<p>Paciente: <input type="text" name="paciente" size="30" value="<%=paciente.getNome()  %>" readonly="readonly"/></p>
			<p><textarea style="text-align: justify" name="evolucaoPaciente" placeholder="Evolução do Paciente" required autofocus
