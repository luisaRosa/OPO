...
<%}else{ %>
			...
			<%
					...
					paciente.setCns(Long.parseLong(request.getParameter("cns")));
					paciente.setRgCT(Long.parseLong(request.getParameter("rgct")));
					paciente.setDt_nascimento(request.getParameter("dnascimento"));
					paciente.setDt_internacao(request.getParameter("dinternacao"));
					paciente.setNomeMae(request.getParameter("mae"));
					paciente.setNomePai(request.getParameter("pai"));
					paciente.setReligiao(request.getParameter("religiao"));
					paciente.setDoador(request.getParameter("doador"));
			...
			<%
				String titulo = "Finalização do processo\n \n";
					...
					geraPdf.geraPdf(titulo, corpo, "Relatório" + request.getParameter("nome")+pacienteLogic.getPaciente(request.getParameter("nome")).getNotificacao().getId() +".pdf");
					String sucesso = "Finalização efetuada com sucesso!";
					request.setAttribute("message", sucesso);
	...
	<fieldset>
		<legend>Dados Pessoais</legend>
			...
			<td><label for="nome">Nome: </label></td>
				<td align="left"><input type="text" name="nome" size="40" value="<%=paciente.getNome()%>" readonly="readonly"></td>
				<td align="center"><label for="idade">Idade: </label></td>
				<td align="left"><input type="number" name="idade" value="<%=paciente.getIdade()%>"></td>
				

					</tr>
					<tr>
						<td><label for="dnascimento">Data de Nascimento:* </label></td>
						<td align="left"><input type="date" name="dnascimento" required autofocus/></td>
						<td><label for="rg"> RG:* </label></td>
						<td align="left"><input type="number" name="rg" required autofocus /></td>
						
					</tr>
					<tr>
						<td><label for="cpf"> CPF:* </label></td>
						<td align="left"><input type="number" name="cpf" size="11" maxlength="11" required autofocus /></td>
						<td><label for="cns"> CNS:* </label></td>
						<td align="left"><input type="number" name="cns" required autofocus  maxlength="15"/></td>
						
						</tr>
						
						<tr>
							<td><label for="rgct"> RG CT:* </label></td>
							<td align="left"><input type="number" name="rgct" required autofocus maxlength="11" /></td>
							<td><label for="religiao"> Religião: </label></td>
							<td align="left"><input type="text" name="religiao"	size="20" required autofocus /></td>
						</tr>
						
						<tr>
							<td><label for="mae"> Nome da mãe: </label></td>
							<td align="left"><input type="text" name="mae" size="30" required autofocus />
							<td><label for="pai">Nome do pai: </label></td>
							<td align="left"><input type="text" name="pai" size="30" required autofocus />
							</td>
							</td>
						</tr>
			...
			<br>	
				...
				<fieldset>
					...
					<table cellspacing="10">
						...
						<tr>
							...
							<td align="left"><input type="text" name="dnot" required autofocus value="<%=data.format(data1.parse(paciente.getNotificacao().getDtNotificacao()))%>"
								readonly="readonly" /></td>
							<td><label for="causa">Causa do Óbito:* </label></td>
							<td align="left"><input type="text" name="causa"  required autofocus></td>
						</tr>
						<tr>
							<td><label for="hospitalid"> Hospital Notificador: </label></td>
							<td align="left"><input type="text" name="hospitalid"	size="35" required autofocus value="<%=paciente.getHospital().getHospitalNotificador()%>"
								readonly="readonly" /></td>
								<td><label for="horigem"> RH <font size="2">(Hospital
										de Origem): </font></label></td>
							<td align="left"><input type="text" name="horigem" size="35"  required autofocus/>
							</td>
						...
						<tr>
							...
							<td align="left"><input type="date" name="dinternacao" required autofocus /></td>
						...
						<tr>
							...
							<td align="left"><input type="radio" name="doador" id="doador" value="sim" "
				...
				<fieldset>
					...
					<table cellspacing="10">
						<tr>
							...
							<td align="left"><input type="text" name="rua" size="40"  required autofocus/>
							</td>
							<td><label for="num">N°:*</label></td>
							<td align="left"><input type="number" name="numCasa" required autofocus	size="7" /></td>
						</tr>
						<tr>
							<td><label for="complemento">Complemento: </label></td>
							<td align="left"><input type="text" name="complemento" required autofocus /></td>
							<td><label for="bairro"> Bairro:* </label></td>
							<td align="left"><input type="text" name="bairro"  required autofocus/></td>
						</tr>
						<tr>
							<td><label for="cep">CEP:* </label></td>
							<td align="left"><input type="number" name="cep"  required autofocus/></td>
							<td><label for="cidade"> Cidade:* </label></td>
							<td align="left"><input type="text" name="cidade" required autofocus /></td>
						</tr>
					</table>
				</fieldset>
				<br />
				...
				<fieldset>
					...
					<table cellspacing="10">
						<tr>
							<td align="left"><label for="nome1">Nome: <input type="text" name="nome1" size="50"  required autofocus/></label></td>
							<td align="left"><label for="parentesco1">Parentesco:
									<input type="text" name="parentesco1" size="15" required autofocus />
							</label></td>
							<td align="left"><label for="telefone1">Telefone: <input type="text" name="telefone1"  required autofocus/></label></td>
						</tr>
						<tr>
							<td align="left"><label for="nome2">Nome: <input type="text" name="nome2" size="50"  required autofocus/></label></td>
							<td align="left"><label for="parentesco2">Parentesco:<input type="text" name="parentesco2" size="15" required autofocus />
							</label></td>
							<td align="left"><label for="telefone2">Telefone: <input type="text" name="telefone2"  required autofocus/></label></td>
						</tr>
					</table>
				</fieldset>
				<br />
				...
				<br /> <input type="submit" value=" Salvar e Gerar Pdf"
					...
					<a href="visualizar.jsp"><input type="button" value="Cancelar" class="buttonmenor" name="cancelar" > </a>
</form>
<% }catch(NullPointerException npe){
