...
public class EvolucaoPacienteDB {
	...
	public int addEvolucaoPaciente(EvolucaoPaciente evolucao)  throws SQLException{

		String UpdateQuery="INSERT INTO evolucaopaciente(EvolucaoPaciente, dataEvolucao, horaEvolucao, paciente_nome, usuarioSistema_cpf)"
				+ " VALUES('"+evolucao.getEvolucaoPaciente()+"', '"
				+evolucao.getDataEvolucao()+"', '"
				+evolucao.getHoraEvolucao()+"', '"
	...
	public EvolucaoPaciente getEvolucao(int id) throws SQLException, ParseException {
		...
		String strQuery = "SELECT idEvolucaoPaciente, EvolucaoPaciente, usuarioSistema_cpf, pacienete_nome, dataEvolucao, horaEvolucao"
		...
		if (rs != null) {
			...
			if (rs.next()) {
				...
				evolucao.setHoraEvolucao(rs.getString("horaEvolucao"));
	...
	public List<EvolucaoPaciente> getEvolucao() throws ParseException {
		...
		String strQuery = "SELECT EvolucaoPaciente, usuarioSistema_cpf, paciente_nome, dataEvolucao, horaEvolucao from evolucaopaciente ORDER BY idEvolucaoPaciente";
