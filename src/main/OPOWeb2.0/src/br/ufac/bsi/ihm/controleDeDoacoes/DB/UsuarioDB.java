...
public class UsuarioDB {
	...
	public int addUsuario(Usuario usuario) throws SQLException{
	...
	public int updUsuario(Usuario usuario) throws SQLException {// ARRUMAR

		String QueryUpdate = "UPDATE usuariosistema SET nome = '" + usuario.getNome() + "', funcao ='"
				+ usuario.getFuncao() + "', localtrabalho='"+ usuario.getLocalTrabalho() + "' WHERE cpf = '" + usuario.getCpf() + "';";
	...
	public int updSenhaUsuario(Usuario usuario) throws SQLException{
		String QueryUpdate = "UPDATE usuariosistema SET senha = '"+usuario.getSenha()+"' WHERE cpf = '"+usuario.getCpf()+"';";
		return conexao.atualize(QueryUpdate);
	}

	public int delUsuario(Usuario usuario) throws SQLException {// ARRUMAR

		String QueryUpdate = "DELETE FROM usuariosistema WHERE cpf='"+usuario.getCpf()+"';";
	...
	public List<Usuario> getUsuarios() {
		...
		String strQuery = "SELECT * FROM usuariosistema ORDER BY nome";
