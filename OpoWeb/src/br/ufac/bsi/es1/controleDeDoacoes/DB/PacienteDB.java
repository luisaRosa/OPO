...
//				paciente.setmNaoDoacao(motivoNaoDoacao);
	...
	public List<Paciente> getPacientes() throws ParseException {
		...
		String strQuery = "SELECT nome, idade, hospital_id, quadroClinico_id, notificacao_id, endereco_id, causaMorte_id, motivoNaoDoacao_id FROM paciente ORDER BY nome";
